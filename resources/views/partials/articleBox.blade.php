<div class="col-sm-16">
    <div class="panel panel-image">
        <div class="image">
            ...
            <div class="type">{{ $article->category->getRoot()->name }} , {{ $article->category->name}} </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <a href="{{ route('article.preview', $article->id) }}" class="btn btn-success btn-sm">مطالعه ادامه مطلب</a>
        </div>
        <div class="panel-footer clearfix">
            <div class="pull-right writer"><i class="glyphicon glyphicon-user"></i>نویسنده :   <a href="#">{{ $article->user->fullname }}</a></div>
